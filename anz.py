...
def logo():
    print("""%s
     _______ __         ___
    / __/ (_) /____   ©    <  /  ╔═══════════════════════╗
   / _// / / __/ -_)   / /   ║  Coded By Sanz-Tzy║
  /___/_/_/\__/\__/  _/ /_   ║    • XNSCODETEAM •      ║
  Multi Brute Force    /____/   ╚═══════════════════════╝
\x1b[1;97m════════════════════════════════════════════════════
\x1b[1;97m║\033[92;1mCreator  \033[97;1m: \033[93;1mSanz-Tzy \033[97;1mX \033[93;1mHaris Ganz\x1b[1;97m                  ║
\x1b[1;97m║\033[92;1mWhatsApp \033[97;1m: \033[93;1m083801xxxxx\x1b[1;97m                            ║
\x1b[1;97m║\033[92;1mGithub   \033[97;1m: \033[93;1mHttps://github.com/Sanz-Tzy\x1b[1;97m            ║
\x1b[1;97m║\033[92;1mFacebook \033[97;1m: \033[93;1mBintang Tzy \033[97;1m[\033[92;1mFollow Me Facebook\033[97;1m]\x1b[1;97m       ║
\x1b[1;97m║\033[92;1m       Crack Facebook random akan kaya teh hijau\x1b[1;97m  ║
\x1b[1;97m════════════════════════════════════════════════════
"""%(N))
...
def moch_yayan():
    ...
    kueh  = {"cookie":_mmk_}
    print(" [•] You IP   : %s"%(O,N,IP));time.sleep(0.03)
    print(" [•] You Name : %s%s%s\n"%(O,N,K,nama,N));time.sleep(0.03)
    print(' [%s01%s] %sCrack id dari anggota grup%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s02%s] %sCrack id dari teman publik%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s03%s] %sCrack id dari total followers%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s04%s] %sCrack id dari like postingan%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s05%s] %sCrack id dari random id massal%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s06%s] %sCrack id dari komentar postingan%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s07%s] %sCrack akun instagram%s [%sBARU%s]'%(O,N,O,N,P,N,H,N));time.sleep(0.03)
    print(' [%s08%s] %sCheckpoint detedtor%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s09%s] %sSettings user agent%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s10%s] %sCheck hasil crack%s'%(O,N,O,N,P,N));time.sleep(0.03)
    print(' [%s00%s] %slogout%s (%shapus cookie%s)'%(O,N,M,N,P,N,M,N));time.sleep(0.03)
    pepek = input('\n [%s*%s] %s+>>> :%s'%(O,N,H,N))
    if pepek == '':
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print('\n [ %spilih method login - silahkan coba satu²%s ]\n'(P,N))
            print(' [%s01%s] %smethod API%s [%sfast%s]'%(O,N,P,N,O,N))
            print(' [%s02%s] %smethod mbasic%s [%slow%s]'%(O,N,P,N,O,N))
            print(' [%s03%s] %smethod mobile%s [%ssuper slow%s]'%(O,N,P,N,O,N))
                    __yan__(pwek.split(','))
                    break
